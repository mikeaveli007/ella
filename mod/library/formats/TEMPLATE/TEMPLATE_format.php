...
function library_show_entry_TEMPLATE($course, $cm, $library, $entry, $mode='', $hook='', $printicons=1, $aliases=true) {
    ...
    if ($entry) {
        ...
        echo '<table class="librarypost TEMPLATE">';
        echo '<tr>';
        ...
        //Call the function
        library_print_entry_approval($cm, $entry, $mode, $approvalalign, $approvalinsidetable);
...
function library_print_entry_TEMPLATE($course, $cm, $library, $entry, $mode='', $hook='', $printicons=1) {
    ...
    return library_show_entry_TEMPLATE($course, $cm, $library, $entry, $mode, $hook, false, false, false);
