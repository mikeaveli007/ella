...
Starting with Moodle 1.4, the library module supports a plugin
architecture to create your own formats. This plugin system allows
you to "invent" your own presentations for your library data. :-)
...
2.-Duplicate the TEMPLATE directory (under mod/library/formats/TEMPLATE).
...
5.-Edit the THENAME_format.php file. Change every ocurrence of TEMPLATE to
   THENAME.
6.-Login into Moodle. Go to any library in your site.
7.-Edit (configure) your library. In the Format popup you'll see a new
...
8.-Edit the THENAME_format.php. Make your format modifications and reload your
   web page to see them in your library. This file has been commented to make
...
9.-If you want to translate your THENAME format name to some nice name to
   be showed in the Format popup, simply, edit your lang/XX/library.php
   file (where XX is your language) and create a new displayformatTHENAME
   string.
10.-Enjoy!! (and don't forget to send your amazing library formats to
   the Library forum on http://moodle.org. They will be welcome!! ;-)

To talk about Library formats, go to:
