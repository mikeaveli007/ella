...
function library_show_entry_fullwithauthor($course, $cm, $library, $entry, $mode="", $hook="", $printicons=1, $aliases=true) {
    ...
    if ($entry) {
        echo '<table class="librarypost fullwithauthor" cellspacing="0">';
        echo '<tr valign="top">';
...
function library_print_entry_fullwithauthor($course, $cm, $library, $entry, $mode="", $hook="", $printicons=1) {
    ...
    return library_show_entry_fullwithauthor($course, $cm, $library, $entry, $mode, $hook, false, false, false);
