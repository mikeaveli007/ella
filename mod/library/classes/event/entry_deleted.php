...
/**
 * The mod_library entry deleted event.
 *
 * @package    mod_library
...
/**
 * The mod_library entry deleted event class.
 *
...
class entry_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('evententrydeleted', 'mod_library');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted the library entry with id '$this->objectid' in " .
    ...
    public function get_url() {
        ...
        return new \moodle_url("/mod/library/view.php", $params);
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'library', 'delete entry',
