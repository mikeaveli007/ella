@mod @mod_library @core_tag @javascript
Feature: Edited library entries handle tags correctly
  In order to get library entries properly labelled
  As a user
  ...
  Background:
    ...
    And I add a "Library" to section "1" and I fill the form with:
      | Name | Test library |
      | Description | A library about dreams! |
    And I log out

  Scenario: Library entry edition of custom tags works as expected
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test library"
    ...
    Then I should see "Example" in the ".library-tags" "css_element"
    And I should see "Entry" in the ".library-tags" "css_element"
    And I should see "Cool" in the ".library-tags" "css_element"
  ...
  Scenario: Library entry edition of standard tags works as expected
    ...
    When I set the following fields to these values:
      ...
      | Tags | OT1, OT3 |
    And I press "Save changes"
    Then I should see "OT1" in the ".library-tags" "css_element"
    And I should see "OT3" in the ".library-tags" "css_element"
    And I should not see "OT2" in the ".library-tags" "css_element"
    And I click on "Edit" "link" in the ".entrylowersection" "css_element"
    And I expand all fieldsets
