@mod @mod_library
Feature: Library entries can be searched or browsed by alphabet, category, date or author
  In order to find entries in a library
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | library | Test library name | Test library description | fullwithauthor | C1     | g1       |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test library name"
    And I add a library entries category named "The ones I like"
    And I add a library entries category named "All for you"
