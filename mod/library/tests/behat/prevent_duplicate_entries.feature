@mod @mod_library
Feature: A teacher can choose whether to allow duplicate entries in a library
  ...
  Scenario: Prevent duplicate entries
    ...
    Then I should see "This concept already exists. No duplicates allowed in this library."
    And I press "Cancel"
